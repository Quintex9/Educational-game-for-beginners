...
def draw_reset_button(screen, level_config, mouse_pos):
    ...
    # Pozícia vedľa menu button (menu je vpravo, reset je pred ním)
    menu_button_w = 100
    menu_button_x = grid_w + console_w - menu_button_w - 15
    x = menu_button_x - w - 10  # 10px medzera medzi tlačidlami
    y = (header_h - h) // 2
    ...
    txt = font.render("RESET", True, START_TEXT_COLOR)
